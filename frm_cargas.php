...
?><form id="form1" name="form1" method="post" action="mnt_cargas.php" autocomplete="off" onsubmit="return validar();">
  <table width="990" border="0" align="center" cellpadding="1" cellspacing="1">
    ...
    <tr>
      ...
      <td width="700"><input name="txtnacimiento" type="text" class="textbox" id="txtnacimiento" value="<?=$info[nacimiento];?>" size="20" maxlength="100" /></td>
    ...
    <div id="div-capacidad">
            <tr>
              ...
              <td colspan="2"><input name="txtesp_ocupado" type="text" class="textbox" id="txtesp_ocupado" value="<?=$info[esp_ocupado];?>" size="20" maxlength="100" readonly="readonly" /></td>
            </tr>
            <tr>
              <td class="lbl">Espacio Disponible:</td>
              <td colspan="2"><input name="txtesp_disponible" type="text" class="textbox" id="txtesp_disponible" value="<?=$info[esp_disponible];?>" size="20" maxlength="100" readonly="readonly" /></td>
            </tr>
    </div>
    <tr>
      <td class="lbl">Fecha de Carga:</td>
      <td colspan="2"><input name="txtfecha_carga" type="text" class="textbox" id="txtfecha_carga" value="<? if(isset($info[fecha_carga])) {echo fecha($info[fecha_carga]);}?>" size="20" maxlength="100" /></td>
      </tr>
      <tr>
    ...
    <tr>
      ...
      <input name="exis" type="hidden" id="exis" value="<?=$exis;?>" /></td>
...
<table width="980" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#D1DDE7">
  ...
  <tr class="<?=set_row_class($cnt_lista);?>">
    ...
    <a href="javascript:void(0);" onclick="cf_eliminar_carga('<?=$ilista[id_cargas];?>');"><img src="images/ic_delete.gif" alt="Eliminar" width="15" height="15" border="0"/></a></div></td>
  </tr>
  <?
  }
  ?>
