...
if($pk){
  $qinfo=runsql("select * from categoria where id_categoria = '$pk'");
...
?>
<form id="form1" name="form1" method="post" action="mnt_categoria.php" autocomplete="off" onsubmit="return validar();">
  <table width="990" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td colspan="3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="96%" background="../images/bg_titulo_frm.gif" class="titulo_frm">Administraci&oacute;n de Categorias para el buscador</td>
          </tr>
      </table></td>
    </tr>
    <?
    ...
    <tr>
      ...
      <td width="700"><div align="left">
        <input name="snombre" type="text" class="textbox" id="snombre" value="<?=$info[snombre];?>" size="50" maxlength="100" />
      </div></td>
...
<br />
<table width="1248" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#D1DDE7">
  <tr>
    <td colspan="5"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="96%" background="../images/bg_titulo_frm.gif" class="titulo_frm">Listado de Categor&iacute;as agregadas</td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td width="267" class="lbl"><div align="center">Id</div></td>
    <td width="267" class="lbl"><strong>Nombre</strong></td>
  ...
  <?
  $cnt_lista=0;
  $qlista=runsql("select * from categoria order by snombre");
  ...
  <tr class="<?=set_row_class($cnt_lista);?>">
    ...
    <td><div align="center"><a href="index1.php?<?="op=$op&pk={$ilista[id_categoria]}";?>"><img src="../images/ic_editar.gif" alt="Modificar" width="15" height="15" border="0" /></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <a href="javascript:void(0);" onclick="cf_eliminar_categoria('<?=$ilista[id_categoria];?>');">
    <img src="../images/ic_delete.gif" alt="Eliminar" width="15" height="15" border="0" />
    </a>
    </div></td>
  </tr>
  <?
