...
//				echo "<br>".$qry_where;
		...
		$query_clientes="select * from cliente ". $qry_where ."order by apellidos ";
	}else{
		$tipo_trn="Add";	
		$query_clientes="select * from cliente order by apellidos";
	}
	
if($pk){
  $qinfo=runsql("select * from cliente where id = '$pk'");
...
?><form id="form1" name="form1" method="post" action="mnt_cliente.php" autocomplete="off" onsubmit="return validar();">
  <table width="990" border="0" align="center" cellpadding="1" cellspacing="1">
    ...
    ?>
    <tr>
      <td width="96" class="lbl"><div align="left">Nombres:</div></td>
      <td width="423" class="parrafo"><div align="left"><input name="txtnombres" type="text" class="textbox_req" id="txtnombres" value="<?=$info[nombres];?>" size="50" maxlength="100" alt="Nombres"/></div></td>
    ...
    <tr>
      ...
      <td class="parrafo"><input name="txtapellidos" type="text" class="textbox_req" id="txtapellidos" value="<?=$info[apellidos];?>" size="50" maxlength="100" alt="Apellidos" /></td>
      <td class="lbl"></td>
      <td class="parrafo"></td>
    </tr>
    <tr>
      <td class="lbl">Direcci&oacute;n:</td>
      <td class="parrafo" ><input name="txtdireccion" type="text" class="textbox" id="txtdireccion" value="<?=$info[direccion];?>" size="70" maxlength="100" /></td>
      <td class="lbl"><span class="lbl">Correo electr&oacute;nico:</span></td>
      <td class="parrafo"><input name="txtemail" type="text" class="textbox_req" id="txtemail" value="<?=$info[email];?>" size="50" maxlength="100" alt="Correo Electrónico"/></td>
    </tr>
        <tr>
      <td class="lbl">Tel. Móvil:</td>
      <td class="parrafo"><input name="txttelmobil" type="text" class="textbox_req" id="txttelmobil" value="<?=$info[telmobil];?>" size="20" maxlength="100" Alt="Teléfono Móvil"/></td>
      <td class="lbl"><span class="lbl">Tel. Casa:</span></td>
      <td class="parrafo"><input name="txttelcasa" type="text" class="textbox" id="txttelcasa" value="<?=$info[telcasa];?>" size="20" maxlength="100" /></td>
    </tr>
        <tr>
      <td class="lbl">Nit:</td>
      <td class="parrafo" ><input name="txtnit" type="text" class="textbox" id="txtnit" value="<?=$info[nit];?>" size="40" maxlength="100" /></td>
	<td class="lbl">Fecha Nacimiento:</td>
	<td class="parrafo"><input name="txtfnac" type="text" class="textbox_req" id="txtfnac" value="<?=fechacorta($info[fnac]);?>" size="15" maxlength="100" alt="Fecha de Nacimiento"/>
    <script language="JavaScript" type="text/javascript">new tcal ({'formname': 'form1','controlname': 'txtfnac'});</script>
    </td>      
    </tr>
    <tr>
      <td class="lbl">Activo:</td>
      <td class="parrafo" ><input name="txtactivo" type="checkbox" id="txtactivo" value="1" <?if($info[activo]==1){echo "checked";}?>/></td>
      <td class="lbl"></td>
      <td class="parrafo"></td>
    </tr>
    <tr>
      ...
      <td class="parrafo" ><input name="button" type="button" class="boton1" id="button" value="Guardar" onclick="val_cliente()"/>
        <strong>
...
<table width="990" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#D1DDE7">
  <tr>
    <td colspan="7"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="96%" background="../images/bg_titulo_frm.gif" class="titulo_frm">Clientes  existentes</td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td width="535" class="lbl"><div align="center"><strong>Nombre del Cliente</strong></div></td>
  ...
  <tr class="<?=set_row_class($cnt_lista);?>">
    ...
    <a href="javascript:void(0);" onclick="cf_eliminar_cliente('<?=$ilista[id];?>');"><img src="../images/ic_delete.gif" alt="Eliminar" title="Eliminar" width="15" height="15" border="0"/></a></div></td>
  </tr>
  <?
  }
  ?>
