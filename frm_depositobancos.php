...
<form id="form1" name="form1" method="post" action="mnt_inventario.php" autocomplete="off" onsubmit="return validar();">
  ...
  <input type="hidden" name="txtexistencia" value="<?=$info[existencia];?>" />
   <table width="990" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    ?>
    <tr>
      <td width="128" class="lbl"><div align="left">Fecha Inicio:</div></td>
      <td width="386">
      <div align="left"><input name="txtfechaini" type="text" class="textbox" id="txtfechaini" value="<? if (isset ($info[fechaini])){echo fecha($info[fechaini]);}else{echo $today;}?>" size="20" maxlength="100"/> 
      <script language="JavaScript" type="text/javascript">new tcal ({'formname': 'form1','controlname': 'txtfechaini'});</script></div>
      </td>
      <td width="152" class="lbl">Fecha Fin:</td>
      <td width="324">
      <div align="left"><input name="txtfechafin" type="text" class="textbox" id="txtfechafin" value="<? if (isset ($info[fechaini])){echo fecha($info[fechaini]);}else{echo $today;}?>" size="20" maxlength="100"/> 
      <script language="JavaScript" type="text/javascript">new tcal ({'formname': 'form1','controlname': 'txtfechafin'});</script></div>
      </td>
    </tr>
...
<table border="0" width="990" align="center" cellpadding="0" cellspacing="1" bgcolor="#D1DDE7">
  ...
  <tr>
    ...
    <td width="127" class="lbl"><div align="center">Saldo (QUE)</div></td>
    <td width="90" class="lbl"><div align="center">DEPOSITO</div></td>
  </tr>
  <?
  $cnt_lista=0;
...
ORDER BY ven.id_venta DESC, cob.fecha ASC;");
  ...
  <tr bgcolor="<?=color_fila($cnt_lista);?>">
    ...
    <div align="center"><a href="index1.php?<?="op=$op&pk={$ilista[id_tran]}";?>">
    <img src="../images/ic_editar.gif" alt="Modificar" width="15" height="15" border="0" /></a></div></td>
  </tr>
  <?
  }
  ?>
