...
<table border="0" width="990" align="center" cellpadding="0" cellspacing="1" bgcolor="#D1DDE7">
  ...
  <tr>
    ...
    <td width="375" class="lbl"><div align="center"><strong>Art&iacute;culo</strong> (M&eacute;dico)</div></td>
  ...
  <?
  $cnt_lista=0;
  $qlista=runsql("select i.*, a.nombre as snombre from inventario i, articulos a where (i.id_articulo=a.id_articulo) order by i.id_tran desc;");
  ...
  <tr bgcolor="<?=color_fila($cnt_lista);?>">
    ...
    <a href="javascript:void(0);" onclick="cf_eliminar_traninv('<?=$ilista[id_tran];?>');"><img src="../images/ic_delete.gif" alt="Eliminar" width="15" height="15" border="0"/></a>
