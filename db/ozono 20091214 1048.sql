...
INSERT INTO `banco` (`id_banco`,`snombre`,`sdireccion`,`stelefono`,`bstatus`) VALUES 
 (1,'Banco Industria','zon 4','0909878',1),
 (2,'Banco Agromercantil','zona 10','9823874',1),
 (3,'Banco de Antigua','zona 5','090923901',1),
...
INSERT INTO `cuenta` (`id_cuenta`,`id_banco`,`stipo`,`smoneda`,`saldo`) VALUES 
 (1,1,'Monetaria','Q',1000),
 (2,1,'Ahorro','Q.',2000),
 (3,4,'Monetaria','Q.',1000),
 (4,4,'Ahorro','Q.',2000);
...
CREATE TABLE `me_permisos` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=6336 DEFAULT CHARSET=latin1;
...
INSERT INTO `paciente` (`id`,`nombres`,`apellidos`,`direccion`,`email`,`fnac`,`activo`) VALUES 
 (6,'wilver','gonzalez','','','0000-00-00 00:00:00',1),
 (7,'sender','flores','','','0000-00-00 00:00:00',1);
...
INSERT INTO `usuarios` (`usuario`,`clave`,`nombre`,`apellido`,`email`,`telefono`,`activo`,`u_acceso`,`ip_uacceso`) VALUES 
 ('waga','waga','Wilver','Gonzalez',NULL,NULL,1,'2009-12-15 07:14:44','127.0.0.1');
