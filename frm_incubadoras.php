...
$(document).ready(function () {
	$("#txtcarga").change(function(evento){	
...
?><form id="form1" name="form1" method="post" action="mnt_descargas.php" autocomplete="off" onsubmit="return validar();">
  <table width="990" border="0" align="center" cellpadding="1" cellspacing="1">
    ...
    <tr>
      ...
      <tr>
      <td class="lbl">Carga No. :</td>
      <td colspan="2"><input name="txtcarga" type="text" class="textbox" id="txtcarga" value="<?=$info[carga];?>" size="40" maxlength="100" /></td>
    </tr> 
      <tr>
    ...
    <tr>
      ...
      <td colspan="2"><input name="txthuevo_pesado" type="text" disabled="disabled" class="textbox" id="txthuevo_pesado" value="<?=$info[huevo_pesado];?>" size="40" maxlength="100" readonly="readonly" /></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td colspan="2"><input name="txtporcentaje" type="text" disabled="disabled" class="textbox" id="txtporcentaje" value="<?=$info[porcentaje];?>" size="40" maxlength="100" readonly="readonly" /></td>
    </tr>
